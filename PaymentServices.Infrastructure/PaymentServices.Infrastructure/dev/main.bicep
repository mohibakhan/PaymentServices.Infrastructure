// =============================================================================
// dev/main.bicep
// DEV Environment — shared App Service Plan, Standard Service Bus
...
param resourceGroupName string = 'rg-pmtsvc-dev'
...
@description('Existing Cosmos DB connection string')
...
// -------------------------------------------------------------------------
// Service Bus — Standard tier for DEV
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// Shared App Service Plan — EP1, all 5 function apps
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// Storage Accounts — one per function app
// -------------------------------------------------------------------------
