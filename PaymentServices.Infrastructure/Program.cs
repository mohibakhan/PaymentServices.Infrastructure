...
public static class Program
{
    ...
    public static async Task Main(string[] args)
    {
        var host = new HostBuilder()
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                // Pre-ledger checks — real Evolve NuGet services
    ...
    /// NuGet stacks. Both read their config docs from the tptch database
    /// (<c>COSMOS_DATABASE</c>) and use PascalCase models, so they get a dedicated
    /// keyed CosmosClient ("limits") with the SDK-default (PascalCase) serializer.
    /// </summary>
