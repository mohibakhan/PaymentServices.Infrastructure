...
public sealed class TchSendRequest
{
    ...
    /// <summary>FBO account resolved by RTPSend's partner-ledger lookup. The
    /// funds-bearing account the Transfer service debits.</summary>
    public string FboAccount { get; set; } = string.Empty;

    /// <summary>Free-text remittance info, screened by Transfer's keyword check.</summary>
